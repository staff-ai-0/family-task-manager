...
/**
 * Wildcard proxy for all /api/cash/* requests.
 *
 ...
 * Authorization. Mirrors api/gigs/[...path].ts.
 *
 * Route: /api/cash/[...path]  →  <BACKEND>/api/cash/<path>
 */
async function proxy({ request, params }: { request: Request; params: Record<string, string | undefined> }): Promise<Response> {
    ...
    try {
        ...
        console.error(`[api/cash proxy] Error forwarding to ${backendUrl}:`, e?.message ?? e);
        return new Response(
