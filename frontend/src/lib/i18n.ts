...
export const translations = {
    en: {
        ...
        pt_view_translation: "View translation",
        pt_translation_hint: "Auto-translated on save — expand to check or edit.",
        ...
        tour_p_gigs_body: "Post one-off paid jobs your kids can claim. 1 point = $1 MXN, so gigs double as allowance.",
        ...
        tour_k_gigs_body: "Grab extra jobs from the gig board for bonus points. Snap a photo as proof.",
    ...
    es: {
        ...
        pt_view_translation: "Ver traducción",
        pt_translation_hint: "Se traduce al guardar — abre para revisar o editar.",
        ...
        tour_p_gigs_body: "Publica trabajos pagados que tus hijos pueden reclamar. 1 punto = $1 MXN, así que los gigs funcionan como domingo.",
        ...
        tour_k_gigs_body: "Toma trabajos extra del tablero de gigs para ganar puntos de bono. Toma una foto como evidencia.",
